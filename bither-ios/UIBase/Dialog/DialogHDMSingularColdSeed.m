...
- (void)loadView {
    ...
    self.page = [[PiPageViewController alloc] initWithStoryboard:self.parent.storyboard viewControllerIdentifiers:@[@"DialogHDMSingularColdSeedChildWords", @"DialogHDMSingularColdSeedChildQr"] andPageDelegate:self];
    ...
    [btn setTitle:NSLocalizedString(@"hdm_singular_cold_seed_remember_button", nil) forState:UIControlStateNormal];
    ...
    lbl.numberOfLines = 0;
    lbl.text = NSLocalizedString(@"hdm_singular_cold_seed_remember_warn", nil);
