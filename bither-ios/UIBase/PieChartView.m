...
-(void)firstConfigure{
    if(!Colors){
        Colors = @[RGBA(254, 39, 93, 1), RGBA(36, 182, 212, 1),
              RGBA(38, 230, 91, 1), RGBA(194, 253, 70,1), RGBA(237, 193, 155,1),
              RGBA(100, 114, 253,1), RGBA(117, 140, 129,1), RGBA(200, 47, 217,1),
              RGBA(239, 204, 41,1), RGBA(253, 38, 38,1), RGBA(253, 160, 38,1),
              RGBA(144, 183, 177,1)];
    }
