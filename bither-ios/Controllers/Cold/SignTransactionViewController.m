...
- (void)viewDidLoad{
    ...
    self.lblAmount.attributedText = [UnitUtil attributedStringForAmount:self.tx.to withFontSize:14];
    self.lblFee.attributedText = [UnitUtil attributedStringForAmount:self.tx.fee withFontSize:14];
