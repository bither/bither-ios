...
@interface HdmSendViewController () <UITextFieldDelegate, ScanQrCodeDelegate, DialogSendTxConfirmDelegate, ShowBannerDelegete, MinerFeeSettingViewControllerDelegate> {
